...
alias dbxc='docker buildx create'
alias dbxdu='docker buildx du'
alias dbxin='docker buildx inspect'
alias dbxls='docker buildx ls'
alias dbxprune='docker buildx prune'
alias dbxrm='docker buildx rm'
alias dbxstop='docker buildx stop'
alias dbxu='docker buildx use'
alias dbxv='docker buildx version'
...
alias -g dcstat='docker container stats'
alias dcstop='docker container stop'
alias -g dctop='docker container top'
...
alias -g dsls='docker service ls'
alias -g dsps='docker service ps'
...
alias -g dstls='docker stack ls'
alias -g dstps='docker stack ps'
